...
import { LayoutDashboard, Recycle, Boxes, Users, UserCog, Receipt, Truck, Wallet, Sun, Moon, LogOut, Menu, X, Globe, ChevronDown, ChevronLeft, ChevronRight, Check, Eye, EyeOff, BarChart3, User as UserIcon, } from 'lucide-react';
...
function LanguageDropdown() {
    ...
    return (_jsxs("div", { className: "relative", ref: ref, children: [_jsxs("button", { type: "button", onClick: () => setOpen((v) => !v), className: "flex h-9 shrink-0 items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-2.5 text-sm font-semibold text-slate-600 transition-colors hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-slate-600", children: [_jsx(Globe, { size: 14, className: "text-slate-400" }), _jsx("span", { children: current.short }), _jsx(ChevronDown, { size: 12, className: `text-slate-400 transition-transform ${open ? 'rotate-180' : ''}` })] }), open && (_jsx("div", { className: "absolute right-0 top-full z-[80] mt-2 w-52 overflow-hidden rounded-2xl border border-slate-200 bg-white py-1.5 shadow-2xl shadow-slate-300/40 dark:border-slate-700 dark:bg-slate-800 dark:shadow-black/40", children: LANG_OPTIONS.map((opt) => (_jsxs("button", { type: "button", onClick: () => {
                        setLang(opt.value);
                        setOpen(false);
...
export function Layout() {
    ...
    return (_jsxs("div", { className: "flex h-screen min-w-0 overflow-hidden bg-slate-50 dark:bg-slate-950", children: [mobileOpen && (_jsx("div", { className: "fixed inset-0 z-20 bg-slate-950/50 backdrop-blur-sm lg:hidden", onClick: () => setMobileOpen(false) })), _jsxs("aside", { className: `fixed top-0 left-0 z-30 flex h-full flex-col border-r border-slate-200 bg-white transition-all duration-300 ease-in-out dark:border-slate-700/50 dark:bg-slate-900 ${collapsed ? 'w-16' : 'w-64'} ${mobileOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`, children: [_jsxs("div", { className: `flex items-center gap-3 border-b border-slate-100 px-4 py-5 dark:border-slate-700/50 ${collapsed ? 'justify-center px-2' : ''}`, children: [_jsx("div", { className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-blue-600 shadow-lg shadow-indigo-500/30", children: _jsx(Recycle, { size: 18, className: "text-white" }) }), !collapsed && (_jsxs("div", { className: "min-w-0", children: [_jsx("p", { className: "truncate text-sm font-semibold text-slate-800 dark:text-white", children: t.brandName }), _jsx("p", { className: "truncate text-[11px] text-slate-400 dark:text-slate-500", children: t.brandSubtitle })] })), _jsx("button", { type: "button", onClick: () => setMobileOpen(false), className: "ml-auto rounded-lg p-2 text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 lg:hidden", "aria-label": "Close", children: _jsx(X, { size: 16 }) })] }), _jsx("nav", { className: "flex-1 space-y-0.5 overflow-y-auto px-2 py-4", children: navItems.map((item) => {
                        ...
                        }) }), _jsx("div", { className: "border-t border-slate-100 p-2 dark:border-slate-700/50", children: _jsx("button", { type: "button", onClick: () => setCollapsed((v) => !v), className: "hidden w-full items-center justify-center rounded-xl p-2.5 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-slate-800 dark:hover:text-white lg:flex", children: collapsed ? _jsx(ChevronRight, { size: 16 }) : _jsx(ChevronLeft, { size: 16 }) }) })] }), _jsxs("div", { className: `flex min-h-0 min-w-0 flex-1 flex-col transition-all duration-300 ${collapsed ? 'lg:ml-16' : 'lg:ml-64'}`, children: [_jsxs("header", { className: "z-10 flex min-h-14 shrink-0 items-center gap-2 border-b border-slate-200 bg-white px-3 py-2 dark:border-slate-700 dark:bg-slate-900 lg:h-14 lg:px-5 lg:py-0", children: [_jsx("button", { type: "button", onClick: () => setMobileOpen(true), className: "rounded-lg p-2 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 lg:hidden", "aria-label": "Menu", children: _jsx(Menu, { size: 18 }) }), _jsx("div", { className: "min-w-0 flex-1", children: _jsx("h1", { className: "truncate text-sm font-semibold text-slate-800 dark:text-white sm:text-base", children: pageTitle }) }), _jsx(NavbarDateRangePicker, {}), _jsxs("div", { className: "flex shrink-0 items-center gap-1.5 sm:gap-2", children: [_jsx("button", { type: "button", onClick: () => setTheme(resolvedTheme === 'dark' ? 'light' : 'dark'), className: "rounded-xl p-2 text-slate-500 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800", "aria-label": "Theme", children: resolvedTheme === 'dark' ? _jsx(Sun, { size: 16 }) : _jsx(Moon, { size: 16 }) }), _jsx(LanguageDropdown, {}), _jsxs("div", { className: "hidden items-center gap-2 border-l border-slate-200 pl-2 dark:border-slate-700 sm:flex", children: [_jsxs("button", { type: "button", onClick: () => setProfileOpen(true), className: "flex max-w-[200px] items-center gap-2 rounded-xl px-1.5 py-1 text-left transition-colors hover:bg-slate-100 dark:hover:bg-slate-800", title: t.authProfileTitle, children: [_jsx("div", { className: "flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-blue-600", children: _jsx(UserIcon, { size: 12, className: "text-white" }) }), _jsxs("div", { className: "hidden min-w-0 md:block", children: [_jsx("p", { className: "truncate text-xs font-medium text-slate-700 dark:text-slate-200", children: user?.fullName ?? '—' }), _jsx("p", { className: "text-[10px] text-slate-400", children: user?.positions?.length ? (_jsx("span", { className: "line-clamp-2 block text-slate-600 dark:text-slate-300", children: user.positions.join(' · ') })) : (_jsx("span", { className: "truncate text-slate-500", children: user?.login ?? '' })) })] })] }), _jsx("button", { type: "button", onClick: () => logout(), title: t.authLogout, className: "rounded-xl p-2 text-slate-500 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800", children: _jsx(LogOut, { size: 16 }) })] }), _jsx("button", { type: "button", onClick: () => setProfileOpen(true), title: t.authProfileTitle, className: "rounded-xl p-2 text-slate-500 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800 sm:hidden", children: _jsx(UserIcon, { size: 16 }) }), _jsx("button", { type: "button", onClick: () => logout(), title: t.authLogout, className: "rounded-xl p-2 text-slate-500 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800 sm:hidden", children: _jsx(LogOut, { size: 16 }) })] })] }), _jsx(ProfileCredentialsDialog, { open: profileOpen, onOpenChange: setProfileOpen }), _jsx("main", { className: "min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden", children: _jsx("div", { className: "mx-auto w-full max-w-[1400px] px-3 py-4 sm:px-5 sm:py-6 lg:px-8", children: _jsx(Outlet, {}) }) })] })] }));
}
