...
const STREET_ENTITY_LABELS: Record<Language, Record<string, string>> = {
  uz_latin: {
    ...
    streetDeleteConfirm:
      "Ko'cha obyektini o'chirishni tasdiqlaysizmi? Ombordagi yozuvlar saqlanadi.",
    ...
    streetDebtIntro:
      "Qarzga olingan xaridlar bo'yicha qoldiq. Ko'cha obyektga naqd berilgan summani bu yerda qayd eting — qoldiq kamayadi.",
    streetDebtNoSuppliers: "Ko'cha obyektlar yo'q",
    streetDebtRepayColSupplier: "Ko'cha obyekt",
    streetDebtOrphanBanner:
      "O'chirilgan ko'cha obyekt bilan bog'langan xaridlarda qarz qoldi (bu summani bu yerda to'lab bo'lmaydi):",
    streetSupplierPurchasesDialogDesc:
      "Bu ko'cha obyektdan olingan mahsulotlar: sana, miqdor, jami, to'langan va qarz.",
  ...
  uz_cyrillic: {
    ...
    streetDeleteConfirm:
      'Кўча объектни ўчиришни тасдиқлайсизми? Омбордаги ёзувлар сақланади.',
    ...
    streetDebtIntro:
      'Қарзга олинган харидлар бўйича қолдиқ. Кўча объектга нақд берилган суммани бу ерда қайд этинг — қолдиқ камаяди.',
    streetDebtNoSuppliers: 'Кўча объектлар йўқ',
    streetDebtRepayColSupplier: 'Кўча объект',
    streetDebtOrphanBanner:
      'Ўчирилган кўча объект билан боғланган харидларда қарз қолди (бу суммани бу ерда тўлаб бўлмайди):',
    streetSupplierPurchasesDialogDesc:
      'Бу кўча объектдан олинган маҳсулотлар: сана, миқдор, жами, тўланган ва қарз.',
  ...
  ru: {
    ...
    streetIntro:
      'Здесь ведёте список уличных объектов. В «Закупке» выберите позицию на складе — приход добавится к её остатку.',
    streetName: 'Уличный объект',
    streetAdd: 'Новый уличный объект',
    streetEdit: 'Изменить уличный объект',
    streetDeleteConfirm:
      'Удалить уличный объект? Записи на складе сохранятся.',
    ...
    streetDebtOrphanBanner:
      'Остался долг по закупкам с удалённым уличным объектом (здесь оплатить нельзя):',
    streetSupplierPurchasesDialogDesc:
