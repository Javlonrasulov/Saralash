...
export function Dashboard() {
    ...
    const warehouseStockProducts = useMemo(() => {
        ...
        for (const w of state.warehouseItems) {
            ...
            if (p)
                parentNameByChildId.set(w.id, p.productName);
        }
