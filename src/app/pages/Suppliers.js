...
import { Plus, Pencil, Search, Phone, MapPin, Truck, ShoppingBag, History, Wallet, Trash2, } from 'lucide-react';
...
export function Suppliers() {
    ...
    const dailyPurchaseOverview = useMemo(() => {
        const inRange = state.supplierPurchases.filter((p) => isYmdInNavFilter(p.incomeDate, navDateFilter));
