...
import { useStore, getSupplierRemainingDebt, getOrphanSupplierDebtIncurred, groupSupplierPurchasesForHistory, } from '../store/saralash-store';
...
export function Suppliers() {
    const { state, addSupplier, updateSupplier, deleteSupplier, purchaseLinesFromSupplier, recordSupplierDebtRepayment, } = useStore();
    const { t } = useApp();
    ...
    const supplierDetailPurchaseGroups = useMemo(() => groupSupplierPurchasesForHistory(supplierDetailPurchases), [supplierDetailPurchases]);
    ...
    const prefPurchasePrice = (w) => {
        if (!w)
            return '';
        const own = w.purchasePricePerUnit != null && Number.isFinite(w.purchasePricePerUnit) && w.purchasePricePerUnit > 0
        ...
        if (w.parentWarehouseId) {
            const parent = state.warehouseItems.find((x) => x.id === w.parentWarehouseId);
            if (parent?.purchasePricePerUnit != null &&
    ...
    const filteredHistoryRows = useMemo(() => {
        let rows = state.supplierPurchases.filter((p) => isYmdInNavFilter(p.incomeDate, navDateFilter));
    ...
    const historyGroups = useMemo(() => groupSupplierPurchasesForHistory(filteredHistoryRows), [filteredHistoryRows]);
    ...
    return (_jsxs("div", { className: "space-y-4", children: [_jsxs(Tabs, { value: mainTab, onValueChange: (v) => setMainTab(v), className: "space-y-4", children: [_jsxs(TabsList, { className: "w-full overflow-x-auto sm:w-auto", children: [_jsxs(TabsTrigger, { value: "list", className: "flex-1 gap-1.5 sm:flex-none", children: [_jsx(Truck, { size: 14 }), t.suppTabSuppliers] }), _jsxs(TabsTrigger, { value: "history", className: "flex-1 gap-1.5 sm:flex-none", children: [_jsx(History, { size: 14 }), t.suppTabHistory, _jsx(Badge, { variant: "muted", className: "ml-0.5 text-[10px]", children: historyGroups.length })] }), _jsxs(TabsTrigger, { value: "debts", className: "flex-1 gap-1.5 sm:flex-none", children: [_jsx(Wallet, { size: 14 }), t.suppTabDebts, debtTabBadgeCount > 0 ? (_jsx(Badge, { variant: "danger", className: "ml-0.5 text-[10px]", children: debtTabBadgeCount })) : null] })] }), _jsxs(TabsContent, { value: "list", className: "mt-0 space-y-4", children: [_jsx(Card, { className: "border-indigo-100 bg-indigo-50/60 p-4 dark:border-indigo-900/40 dark:bg-indigo-950/30", children: _jsx("p", { className: "text-sm text-indigo-900 dark:text-indigo-200", children: t.suppIntro }) }), _jsxs(Card, { className: "overflow-hidden border-emerald-200/70 bg-gradient-to-br from-emerald-50/80 via-white to-teal-50/40 p-0 shadow-sm dark:border-emerald-900/40 dark:from-emerald-950/40 dark:via-slate-900 dark:to-teal-950/20", children: [_jsxs("div", { className: "flex items-start justify-between gap-3 border-b border-emerald-100/80 px-4 py-3.5 dark:border-emerald-900/50", children: [_jsxs("div", { className: "flex min-w-0 items-center gap-3", children: [_jsx("div", { className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-md shadow-emerald-500/25", children: _jsx(Package, { size: 18 }) }), _jsxs("div", { className: "min-w-0", children: [_jsx("h3", { className: "text-sm font-semibold text-slate-800 dark:text-white", children: purchaseSummaryTitle }), _jsx("p", { className: "mt-0.5 text-xs text-slate-500 dark:text-slate-400", children: purchaseSummaryPeriodLabel })] })] }), todayPurchaseItems.length > 0 && (_jsxs("div", { className: "shrink-0 rounded-xl border border-emerald-100/90 bg-white/80 px-3 py-2 text-right shadow-sm dark:border-emerald-900/50 dark:bg-slate-800/80", children: [todayPurchaseStats.totalKg > 0 && (_jsxs("p", { className: "nums text-lg font-bold leading-none text-emerald-800 dark:text-emerald-300", children: [formatQuantity(todayPurchaseStats.totalKg, 'kg'), _jsx("span", { className: "ml-1 text-xs font-semibold text-emerald-600 dark:text-emerald-400", children: "kg" })] })), todayPurchaseStats.totalPcs > 0 && (_jsxs("p", { className: `nums font-bold leading-none text-emerald-800 dark:text-emerald-300 ${todayPurchaseStats.totalKg > 0
                    ...
                    requestClosePurchaseDialog();
                }, children: _jsxs(DialogContent, { className: "max-h-[90vh] overflow-y-auto sm:max-w-xl", children: [_jsxs(DialogHeader, { children: [_jsx(DialogTitle, { children: t.suppPurchaseTitle }), _jsxs(DialogDescription, { className: "space-y-2 text-pretty", children: [purchaseSelectedSupplier ? (_jsx("span", { className: "font-medium text-slate-800 dark:text-slate-100", children: purchaseSelectedSupplier.fullName })) : null, _jsx("span", { className: "block", children: t.suppPurchaseDesc }), _jsx("span", { className: "block text-slate-600 dark:text-slate-300", children: t.suppPurchaseParentNote })] })] }), _jsxs("form", { onSubmit: handlePurchaseSubmit, className: "space-y-4", children: [_jsxs("div", { children: [_jsxs(Label, { children: [t.suppPurchasePickSupplier, " *"] }), _jsxs(Select, { value: purchaseForm.supplierId || undefined, onValueChange: (v) => setPurchaseForm((f) => ({ ...f, supplierId: v })), children: [_jsx(SelectTrigger, { className: "mt-1.5", children: _jsx(SelectValue, { placeholder: t.suppPurchasePickSupplier }) }), _jsx(SelectContent, { children: state.suppliers.map((s) => (_jsx(SelectItem, { value: s.id, children: s.fullName }, s.id))) })] })] }), _jsxs("div", { children: [_jsx(Label, { children: t.whIncomeDate }), _jsx(Input, { type: "date", value: purchaseForm.incomeDate, onChange: (e) => setPurchaseForm((f) => ({ ...f, incomeDate: e.target.value })), className: "mt-1.5 max-w-[12rem]" })] }), warehousePurchaseOptions.length === 0 ? (_jsx("p", { className: "text-sm text-amber-700 dark:text-amber-300", children: t.suppNoParentProducts })) : (_jsxs("div", { className: "space-y-2", children: [_jsx(Label, { children: t.suppPurchaseLinesTitle }), (() => {
                                            ...
                                            return (_jsxs(_Fragment, { children: [collapsedLines.map((line) => {
                                                    ...
                                                    }), editingLine && (_jsxs("div", { className: "space-y-2 rounded-xl border border-sky-200 bg-sky-50/40 p-3 dark:border-sky-900/50 dark:bg-sky-950/20", children: [_jsxs(Label, { className: "text-xs", children: [t.suppPurchasePickParent, " *"] }), _jsxs(Select, { value: editingLine.warehouseItemId || undefined, onValueChange: (v) => selectPurchaseWarehouse(editingLine.key, v), children: [_jsx(SelectTrigger, { className: "rounded-xl", children: _jsx(SelectValue, { placeholder: t.suppPurchasePickParent }) }), _jsx(SelectContent, { className: "max-h-72", children: warehousePurchaseOptions.map((opt) => (_jsx(SelectItem, { value: opt.id, children: warehouseSessionLabel(opt) }, opt.id))) })] }), editW && (_jsx("p", { className: "text-[10px] text-slate-500", children: t.suppPurchaseSessionQtyHint })), _jsxs("div", { className: "space-y-2", children: [_jsx(CumulativeQuantityField, { label: _jsxs(_Fragment, { children: [t.whQuantity, " *"] }), quantity: editingLine.quantity, qtyParts: editingLine.qtyParts, unit: editW?.unit ?? 'kg', unitLabel: editW?.unit === 'pcs' ? t.unitPcs : 'kg', runningTotalLabel: t.suppQtyRunningTotal, addAriaLabel: t.suppQtyAddPart, placeholder: editW?.unit === 'kg' ? '2,3' : '5', pcsHint: editW?.unit === 'pcs' ? t.suppPurchasePcsWhole : undefined, onQuantityChange: (value) => updatePurchaseLine(editingLine.key, { quantity: value }), onAddPart: () => appendPurchaseQtyPart(editingLine.key) }), _jsxs("div", { children: [_jsx(Label, { className: "text-xs", children: t.suppPricePerUnit }), _jsx(Input, { value: editingLine.pricePerUnit, onChange: (e) => updatePurchaseLine(editingLine.key, {
                                                                                    pricePerUnit: e.target.value,
                                                                                }), className: "mt-1 rounded-xl", inputMode: "decimal" })] })] }), _jsxs("p", { className: "text-xs text-slate-600 dark:text-slate-300", children: [t.suppLineTotal, ":", ' ', _jsx("span", { className: "nums font-semibold", children: editTotal != null ? `${formatNumber(editTotal)} so'm` : '—' })] })] }))] }));
                                        })()] })), purchaseByProductSummary.length > 0 && (_jsxs("div", { className: "rounded-lg border border-indigo-100 bg-indigo-50/50 px-3 py-2.5 dark:border-indigo-900/50 dark:bg-indigo-950/30", children: [_jsx("p", { className: "text-xs font-medium text-indigo-800 dark:text-indigo-200", children: t.suppByProductSummary }), _jsx("ul", { className: "mt-2 space-y-1.5 text-sm", children: purchaseByProductSummary.map((g) => (_jsxs("li", { className: "flex flex-wrap items-baseline justify-between gap-2 text-slate-800 dark:text-slate-100", children: [_jsx("span", { className: "min-w-0 truncate font-medium", children: g.label }), _jsxs("span", { className: "nums shrink-0 text-right text-xs sm:text-sm", children: [formatQuantity(g.qty, g.unit), " ", g.unit === 'kg' ? 'kg' : t.unitPcs, g.hasPrice ? ` · ${formatNumber(g.amount)} so'm` : ''] })] }, g.id))) })] })), _jsxs("div", { className: "rounded-lg border border-slate-200 bg-slate-50/80 px-3 py-2.5 dark:border-slate-700 dark:bg-slate-900/40", children: [_jsx("p", { className: "text-xs text-slate-500", children: t.suppPurchaseGrandTotal }), _jsx("p", { className: "nums text-lg font-semibold text-slate-900 dark:text-slate-100", children: purchaseOrderTotal != null ? `${formatNumber(purchaseOrderTotal)} so'm` : '—' })] }), _jsxs("div", { children: [_jsxs(Label, { children: [t.suppPaidAmount, purchaseOrderTotal != null ? ' *' : ''] }), _jsx(Input, { value: purchaseForm.paidAmount, onChange: (e) => setPurchaseForm((f) => ({ ...f, paidAmount: e.target.value })), className: "mt-1.5", placeholder: "0", inputMode: "decimal", disabled: purchaseOrderTotal == null || !purchaseForm.onCredit }), purchaseForm.onCredit && purchaseOrderTotal != null && debtPreviewSo != null && (_jsxs("p", { className: "mt-1 text-xs font-medium text-amber-800 dark:text-amber-200", children: [t.suppDebtPreview, ": ", formatNumber(debtPreviewSo), " so'm"] }))] }), _jsxs("label", { className: "flex cursor-pointer items-start gap-3 rounded-lg border border-slate-200 p-3 dark:border-slate-700", children: [_jsx("input", { type: "checkbox", className: "mt-0.5 h-4 w-4 shrink-0 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 dark:border-slate-600", checked: purchaseForm.onCredit, onChange: (e) => setPurchaseForm((f) => ({ ...f, onCredit: e.target.checked })) }), _jsx("span", { className: "text-sm leading-snug text-slate-700 dark:text-slate-300", children: t.suppOnCredit })] }), _jsxs("div", { children: [_jsx(Label, { children: t.notes }), _jsx(Input, { value: purchaseForm.notes, onChange: (e) => setPurchaseForm((f) => ({ ...f, notes: e.target.value })), className: "mt-1.5" })] }), _jsxs(DialogFooter, { children: [_jsx(Button, { type: "button", variant: "outline", onClick: () => setPurchaseDiscardConfirmOpen(true), children: t.cancel }), _jsx(Button, { type: "submit", children: t.suppPurchaseSubmit })] })] })] }) }), _jsx(AlertDialog, { open: purchaseDiscardConfirmOpen, onOpenChange: setPurchaseDiscardConfirmOpen, children: _jsxs(AlertDialogContent, { children: [_jsxs(AlertDialogHeader, { children: [_jsx(AlertDialogTitle, { children: t.suppPurchaseDiscardTitle }), _jsx(AlertDialogDescription, { children: t.suppPurchaseDiscardDesc })] }), _jsxs(AlertDialogFooter, { children: [_jsx(AlertDialogCancel, { children: t.cancel }), _jsx(AlertDialogAction, { onClick: closePurchaseDialog, children: t.confirm })] })] }) }), _jsx(Dialog, { open: debtRepayOpen, onOpenChange: (open) => {
                ...
                }, children: _jsxs(DialogContent, { className: "max-h-[90vh] max-w-[calc(100vw-2rem)] overflow-y-auto sm:max-w-3xl", children: [_jsxs(DialogHeader, { children: [_jsx(DialogTitle, { children: supplierDetail?.fullName ?? '' }), _jsx(DialogDescription, { children: t.suppSupplierPurchasesDialogDesc })] }), _jsx("div", { className: "hidden max-h-[min(55vh,28rem)] overflow-auto md:block", children: _jsxs(Table, { children: [_jsx(TableHeader, { children: _jsxs(TableRow, { children: [_jsx(TableHead, { children: t.suppHistoryColDate }), _jsx(TableHead, { children: t.suppHistoryColProducts }), _jsx(TableHead, { className: "text-right", children: t.suppHistoryColTotal }), _jsx(TableHead, { className: "text-right", children: t.suppHistoryColPaid }), _jsx(TableHead, { className: "text-right", children: t.suppHistoryColDebt }), _jsx(TableHead, { className: "w-[3rem]" })] }) }), _jsx(TableBody, { children: supplierDetailPurchaseGroups.length === 0 ? (_jsx(TableEmpty, { colSpan: 6, message: t.suppHistoryNoData })) : (supplierDetailPurchaseGroups.map((g) => {
                                            const { totalAmount, paid, debt } = batchMoneyTotals(g);
                                            return (_jsxs(TableRow, { children: [_jsx(TableCell, { className: "whitespace-nowrap text-xs text-slate-600 dark:text-slate-300", children: formatDate(g.incomeDate) }), _jsxs(TableCell, { className: "max-w-[20rem]", children: [_jsx("p", { className: "text-sm font-medium leading-snug", children: summarizeBatchProducts(g.lines) }), _jsxs("p", { className: "text-[10px] text-slate-400", children: [g.lines.length, " ", t.suppHistoryProductCount] })] }), _jsx(TableCell, { className: "nums text-right font-semibold", children: totalAmount > 0 ? `${formatNumber(totalAmount)} so'm` : '—' }), _jsx(TableCell, { className: "nums text-right text-slate-600 dark:text-slate-300", children: paid > 0 || totalAmount > 0 ? `${formatNumber(paid)} so'm` : '—' }), _jsx(TableCell, { className: "nums text-right text-amber-700 dark:text-amber-300", children: debt > 1e-6 ? `${formatNumber(debt)} so'm` : '—' }), _jsx(TableCell, { children: _jsx(Button, { type: "button", variant: "ghost", size: "icon", className: "h-8 w-8", onClick: () => setHistoryEditBatch(g), children: _jsx(Pencil, { size: 15 }) }) })] }, g.batchId));
                                        })) })] }) }), _jsx("div", { className: "max-h-[min(50vh,24rem)] space-y-3 overflow-y-auto md:hidden", children: supplierDetailPurchaseGroups.length === 0 ? (_jsx("p", { className: "py-6 text-center text-sm text-slate-400", children: t.suppHistoryNoData })) : (supplierDetailPurchaseGroups.map((g) => {
                                const { totalAmount, paid, debt } = batchMoneyTotals(g);
                                return (_jsxs(Card, { className: "p-4", children: [_jsxs("div", { className: "mb-2 flex justify-between", children: [_jsx("span", { className: "text-xs text-slate-500", children: formatDate(g.incomeDate) }), _jsx(Button, { type: "button", variant: "ghost", size: "icon", className: "h-8 w-8", onClick: () => setHistoryEditBatch(g), children: _jsx(Pencil, { size: 15 }) })] }), _jsx("p", { className: "text-sm leading-snug", children: summarizeBatchProducts(g.lines) }), _jsx("p", { className: "mt-2 nums font-semibold", children: totalAmount > 0 ? `${formatNumber(totalAmount)} so'm` : '—' }), debt > 1e-6 && (_jsxs("p", { className: "text-xs text-amber-700", children: [t.suppHistoryColDebt, ": ", formatNumber(debt), " so'm"] }))] }, g.batchId));
                                    ...
                                    }, children: [_jsx(History, { size: 16 }), t.suppOpenInHistoryTab] })) : null] })] }) }), _jsx(SupplierPurchaseEditDialog, { batch: historyEditBatch, open: Boolean(historyEditBatch), onOpenChange: (o) => {
                    if (!o)
                        setHistoryEditBatch(null);
                }, warehouseOptions: warehousePurchaseOptions, warehouseProductTitle: warehouseProductTitle, prefPrice: prefPurchasePrice }), _jsx(AlertDialog, { open: Boolean(confirmDelete), onOpenChange: () => setConfirmDelete(null), children: _jsxs(AlertDialogContent, { children: [_jsxs(AlertDialogHeader, { children: [_jsx(AlertDialogTitle, { children: t.suppDeleteConfirm }), _jsx(AlertDialogDescription, { children: confirmDelete?.fullName })] }), _jsxs(AlertDialogFooter, { children: [_jsx(AlertDialogCancel, { children: t.cancel }), _jsx(AlertDialogAction, { onClick: handleDelete, children: t.confirm })] })] }) })] }));
}
