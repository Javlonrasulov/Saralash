                    ...
                    if (!open) {
                        ...
                        setPurchaseEditingKey('');
                                            ...
                                            return (_jsxs(_Fragment, { children: [collapsedLines.map((line) => {
                                                    ...
                                                    }), editingLine && (_jsxs("div", { className: "space-y-2 rounded-xl border border-sky-200 bg-sky-50/40 p-3 dark:border-sky-900/50 dark:bg-sky-950/20", children: [_jsxs(Label, { className: "text-xs", children: [t.suppPurchasePickParent, " *"] }), _jsxs(Select, { value: editingLine.warehouseItemId || undefined, onValueChange: (v) => {
                                                                    const item = state.warehouseItems.find((x) => x.id === v);
                                                                    updatePurchaseLine(editingLine.key, {
                                                                        warehouseItemId: v,
                                                                        pricePerUnit: prefPurchasePrice(item),
                                                                    });
                                                                }, children: [_jsx(SelectTrigger, { className: "rounded-xl", children: _jsx(SelectValue, { placeholder: t.suppPurchasePickParent }) }), _jsx(SelectContent, { className: "max-h-72", children: warehousePurchaseOptions.map((opt) => (_jsx(SelectItem, { value: opt.id, children: warehouseSessionLabel(opt) }, opt.id))) })] }), editW && (_jsx("p", { className: "text-[10px] text-slate-500", children: t.suppPurchaseSessionQtyHint })), _jsxs("div", { className: "grid gap-2 sm:grid-cols-2", children: [_jsx(CumulativeQuantityField, { label: _jsxs(_Fragment, { children: [t.whQuantity, " *"] }), quantity: editingLine.quantity, qtyParts: editingLine.qtyParts, unit: editW?.unit ?? 'kg', unitLabel: editW?.unit === 'pcs' ? t.unitPcs : 'kg', runningTotalLabel: t.suppQtyRunningTotal, addAriaLabel: t.suppQtyAddPart, placeholder: editW?.unit === 'kg' ? '2,3' : '5', pcsHint: editW?.unit === 'pcs' ? t.suppPurchasePcsWhole : undefined, onQuantityChange: (value) => updatePurchaseLine(editingLine.key, { quantity: value }), onAddPart: () => appendPurchaseQtyPart(editingLine.key) }), _jsxs("div", { children: [_jsx(Label, { className: "text-xs", children: t.suppPricePerUnit }), _jsx(Input, { value: editingLine.pricePerUnit, onChange: (e) => updatePurchaseLine(editingLine.key, {
                                                                                    pricePerUnit: e.target.value,
                                                                                }), className: "mt-1 rounded-xl", inputMode: "decimal" })] })] }), _jsxs("p", { className: "text-xs text-slate-600 dark:text-slate-300", children: [t.suppLineTotal, ":", ' ', _jsx("span", { className: "nums font-semibold", children: editTotal != null ? `${formatNumber(editTotal)} so'm` : '—' })] })] })), _jsxs(Button, { type: "button", variant: "outline", size: "sm", className: "w-full rounded-xl", onClick: commitPurchaseLineAndAddNext, children: [_jsx(Plus, { size: 14, className: "mr-1.5" }), t.suppAddPurchaseLine] })] }));
