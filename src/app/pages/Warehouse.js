...
export function Warehouse() {
    ...
    const usedOutcomes = useMemo(() => state.outcomes.filter((o) => o.type === 'CONSUMED' && isYmdInNavFilter(o.date, navDateFilter)), [state.outcomes, navDateFilter]);
    ...
    return (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "grid grid-cols-1 gap-3 sm:grid-cols-3", children: [_jsxs(Card, { className: "flex items-center gap-3 p-4", children: [_jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-blue-100 dark:bg-blue-900/30", children: _jsx(Package, { size: 18, className: "text-blue-600 dark:text-blue-400" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-slate-500 dark:text-slate-400", children: "kg jami" }), _jsxs("p", { className: "nums text-lg font-bold", children: [formatNumber(totalsByUnit.kg), " kg"] })] })] }), _jsxs(Card, { className: "flex items-center gap-3 p-4", children: [_jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-100 dark:bg-emerald-900/30", children: _jsx(TrendingUp, { size: 18, className: "text-emerald-600 dark:text-emerald-400" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-slate-500 dark:text-slate-400", children: t.whTabSold }), _jsx("p", { className: "nums text-lg font-bold", children: soldOutcomes.length })] })] }), _jsxs(Card, { className: "flex items-center gap-3 p-4", children: [_jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-amber-100 dark:bg-amber-900/30", children: _jsx(TrendingDown, { size: 18, className: "text-amber-600 dark:text-amber-400" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-slate-500 dark:text-slate-400", children: t.whTabUsed }), _jsx("p", { className: "nums text-lg font-bold", children: usedOutcomes.length })] })] })] }), _jsxs(Tabs, { value: tab, onValueChange: (v) => setTab(v), children: [_jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [_jsxs(TabsList, { className: "w-full overflow-x-auto sm:w-auto", children: [_jsxs(TabsTrigger, { value: "stock", className: "flex-1 sm:flex-none", children: [t.whTabStock, _jsx(Badge, { variant: "muted", className: "ml-1 text-[10px]", children: orderedFilteredStock.length })] }), _jsxs(TabsTrigger, { value: "sold", className: "flex-1 sm:flex-none", children: [t.whTabSold, _jsx(Badge, { variant: "muted", className: "ml-1 text-[10px]", children: soldOutcomes.length })] }), _jsxs(TabsTrigger, { value: "used", className: "flex-1 sm:flex-none", children: [t.whTabUsed, _jsx(Badge, { variant: "muted", className: "ml-1 text-[10px]", children: usedOutcomes.length })] })] }), tab === 'stock' && (_jsxs(Button, { onClick: () => {
                                    ...
                                    setProductDialogOpen(true);
                                            ...
                                            })) })] }) }), _jsx("div", { className: "space-y-3 md:hidden", children: warehouseStockGroups.length === 0 ? (_jsx(Card, { className: "p-8 text-center text-sm text-slate-400", children: t.noData })) : (warehouseStockGroups.map(({ root, children }) => {
                                    const rootMeta = categoryMeta(root.category);
                                    const separatedSum = childrenQtySumByRootId.get(root.id) ?? 0;
                                    const showSeparatedHint = children.length > 0 && separatedSum > 1e-9;
                                    return (_jsxs(Card, { className: "overflow-hidden border-slate-200/90 dark:border-slate-600", children: [_jsxs("div", { className: "border-b border-slate-100 bg-slate-50/80 p-4 dark:border-slate-700 dark:bg-slate-800/50", children: [_jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: `flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${rootMeta.iconBg} text-lg`, children: _jsx("span", { children: rootMeta.emoji }) }), _jsxs("div", { className: "min-w-0 flex-1", children: [_jsx("p", { className: "truncate text-sm font-semibold text-slate-800 dark:text-white", children: root.productName }), _jsxs("div", { className: "mt-1 flex flex-wrap items-center gap-1.5", children: [root.source === 'PROCESSED' && (_jsx(Badge, { variant: "muted", className: "text-[10px]", children: t.sortingProcessed })), root.source === 'SUPPLIER' && (_jsxs(Badge, { variant: "muted", className: "text-[10px]", children: [t.whSourceSupplier, root.supplierName ? `: ${root.supplierName}` : ''] })), _jsx(Badge, { className: rootMeta.badge, children: categoryLabel(root.category, t) }), _jsx("span", { className: "text-[11px] text-slate-400", children: formatDate(root.incomeDate) })] }), _jsxs("p", { className: `mt-2 nums text-base font-bold ${rootMeta.text}`, children: [formatNumber(root.currentQty), " ", root.unit] }), showSeparatedHint && (_jsxs("p", { className: "mt-1 text-[11px] text-slate-500 dark:text-slate-400", children: [t.whFamilyTotal, ": ", formatNumber(separatedSum), ' ', root.unit === 'kg' ? 'kg' : t.unitPcs] })), _jsxs("p", { className: "mt-1 text-[11px] text-slate-600 dark:text-slate-300", children: [t.whColPurchaseShort, ": ", formatWarehouseUnitPrice(root.purchasePricePerUnit), " \u00B7", ' ', t.whColSaleShort, ": ", formatWarehouseUnitPrice(root.salePricePerUnit)] }), _jsx("p", { className: "mt-1 truncate text-xs text-slate-500", children: root.notes ?? '—' })] })] }), _jsxs("div", { className: "mt-3 flex flex-wrap gap-2 border-t border-slate-200/80 pt-3 dark:border-slate-600", children: [_jsx(Button, { size: "sm", variant: "ghost", onClick: () => {
                                                                    setEditingProduct(root);
                                                                    setProductDialogOpen(true);
                                                                }, children: _jsx(Pencil, { size: 13 }) }), _jsx(Button, { size: "sm", variant: "ghost", className: "hover:text-red-600", onClick: () => setConfirmDelete(root), children: _jsx(Trash2, { size: 13 }) })] })] }), children.length > 0 && (_jsx("div", { className: "divide-y divide-slate-100 dark:divide-slate-700", children: children.map((w) => {
                                                    const meta = categoryMeta(w.category);
                                                    return (_jsxs("div", { className: "bg-indigo-50/30 p-4 pl-6 dark:bg-indigo-950/15", children: [_jsxs("div", { className: "flex items-start gap-3", children: [_jsx("span", { className: "mt-1 font-mono text-indigo-500 dark:text-indigo-400", children: "\u2514" }), _jsxs("div", { className: "min-w-0 flex-1", children: [_jsxs("p", { className: "truncate text-sm font-medium text-slate-800 dark:text-white", children: [w.productName, _jsx(Badge, { variant: "outline", className: "ml-2 align-middle text-[9px] font-normal", children: t.whSubLineBadge })] }), _jsxs("div", { className: "mt-1 flex flex-wrap items-center gap-1.5", children: [_jsx(Badge, { className: meta.badge, children: categoryLabel(w.category, t) }), _jsx("span", { className: "text-[11px] text-slate-400", children: formatDate(w.incomeDate) })] }), _jsxs("p", { className: `mt-1.5 nums text-sm font-semibold ${meta.text}`, children: [formatNumber(w.currentQty), " ", w.unit] }), _jsxs("p", { className: "mt-1 text-[11px] text-slate-600 dark:text-slate-300", children: [t.whColPurchaseShort, ": ", formatWarehouseUnitPrice(w.purchasePricePerUnit), " \u00B7", ' ', t.whColSaleShort, ": ", formatWarehouseUnitPrice(w.salePricePerUnit)] })] })] }), _jsxs("div", { className: "mt-2 flex flex-wrap gap-2", children: [_jsx(Button, { type: "button", size: "sm", variant: "outline", className: "h-8 text-emerald-600", title: t.whChildAddQtyTitle, onClick: () => {
                                                                            setChildAddTarget(w);
                                                                            setChildAddQtyInput('');
